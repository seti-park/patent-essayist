...
## Claim 1 Locks A Rising-Risk, Clearance-Gated Drop
...
**Pinned.** A few numbers are example points, not guarantees. On fall-extent reduction, claim 13 commits only to "at least 50%"; the "at least 30%" figure sits in the description [0029] and binds nothing on its own. The decision-loop rates such as 1 Hz or 10 Hz are illustrative too. None of that should be read as a bound the independent claim states.
...
## Most Ways Around It Make A Worse Robot
...
The walk gets the demos. The safe stop is what gets the robot into the building, and that is the part Agility has moved to protect.
