...
rationale: same publisher finding, §5 leg. The steelman and both-or-neither collateral discipline are contract-required and kept at full strength; what was cut is procedure narration beyond the label-sentence budget. Gates re-run after edit: 14/14 PASS, zero findings (warns included), signature lines 1-3 byte-intact, publication.md re-stripped (2,903 words).
