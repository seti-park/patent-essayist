...
- **통념**: rotor bridge leakage is treated as an unavoidable structural tax.
- **Citations**:
  - (no external citation collected — "everyone knows" the bridge tax)

- **전복**: the patent removes the steel bridge entirely.
...
## Spine → section trace
| Section | Arc role | Spine element |
|---|---|---|
| 1-lead | lead | hook |
| 2-development | development | mechanism |
| 3-turn | turn (reversal) | reframe |
| 4-closing | closing | recap |
